export const getClientApp = (subdomain) => {
  return [
    ...
    },
    {
      ...
      description: "Support and chat solutions",
      url: {
    ...
    },
    {
      ...
      description: "Build forms & collect data",
      url: {
    ...
    },
    {
      ...
      description: "Inform your customers of new features",
      url: {
    ...
    },
    {
      ...
      description: "Customer engagement tool",
      url: {
    ...
    },
    {
      ...
      description: "Build stunning looking quizzes",
      url: {
    ...
    },
    {
      ...
      description: "For coding assessments & technical interviews",
      url: {
    ...
    },
    {
      ...
      description: "Record user sessions for better analysis",
      url: {
    ...
    },
    {
      ...
      description: "Simple User Testing Tool",
      url: {
    ...
    },
    {
      ...
      description: "Build and sell courses online",
      url: {
    ...
    },
    {
      name: "Testify",
      icon: "",
      description: "Test management software",
      url: {
    ...
    },
    {
      ...
      description: "Build stunning looking websites",
      url: {
