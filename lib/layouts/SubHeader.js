...
const SubHeader = ({
  ...
  const [searchVisibility, setSearchVisibility] = useState(
    searchProps ? searchProps.value || !searchProps.clear : false
  );
        ...
        {searchProps && (
          ...
          >
            <Input
              ...
              data-cy={ searchProps.dataCy || "search-input-field" }
              prefix={
      ...
      <div className="flex flex-row items-center justify-end">
        {deleteButtonProps && (
          <Button
            ...
            data-cy={deleteButtonProps.dataCy || "delete-button" }
            {...deleteButtonProps}
          />
        )}
        ...
        {sortProps && (
          <Dropdown
            ...
            position="bottom-right"
            data-cy={sortProps && sortProps.dataCy}
          >
