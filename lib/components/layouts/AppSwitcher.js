...
import { Check, Left } from "@bigbinary/neeto-icons";
  ...
  return (
    <>
      <div className="neeto-ui-app-switcher__header">
        <Button label="Back" icon={Left} style="text" iconPosition="left" onClick={onClose} />
      </div>
...
AppSwitcher.propTypes = {
  ...
  environment: PropTypes.oneOf(Object.values(envs)),
  v2: PropTypes.bool
};
