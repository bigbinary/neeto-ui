      ...
      <div className="neeto-ui-sidebar__footer">
        ...
        {showAppSwitcher && (
          <button
            ...
            className="flex items-center justify-start w-full bg-transparent shadow-none select-none neeto-ui-sidebar__link neeto-ui-sidebar__link--button"
          >
            <NavIconWrapper collapsed={collapsed} mainLabel="App Switcher">
              <span className="flex items-center justify-center neeto-ui-sidebar__link-icon">
                <AppSwitcher
                  size={32}
                  className="rounded-sm neeto-ui-bg-gray-100"
                />
              </span>
            </NavIconWrapper>
            {!collapsed && (
