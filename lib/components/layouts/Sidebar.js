...
export const ProfileSection = ({ collapsed, profileInfo, onClick }) => {
  ...
  return (
    <div className="neeto-ui-sidebar__profile-wrapper" onClick={onClick}>
      <div className="neeto-ui-sidebar__profile">
        <Avatar user={profileInfo} size="large" />
        {!collapsed && (
          <div className="neeto-ui-sidebar__profile-content">
            <div className="neeto-ui-sidebar__profile-info">
              <h4>{truncate(profileInfo.name, 18)}</h4>
              <p>{truncate(profileInfo.email, 23)}</p>
            </div>
            <Down size={16} />
          </div>
        )}
...
const Sidebar = ({
  ...
  return (
    <div
      className={classnames("neeto-ui-sidebar", {
        "neeto-ui-sidebar--collapsed": collapsed,
      })}
    >
      <div className="neeto-ui-sidebar__header">
        <div className="neeto-ui-sidebar__logo">
            ...
            return (
              <React.Fragment key={mainIndex}>
                <NavLink
                  ...
                  className="neeto-ui-sidebar__link"
                      ...
                      (
                        ...
                        return (
                          <NavLink
                            key={subIndex}
                            to={subRoute}
                            className="neeto-ui-sidebar__sublink"
                            activeClassName="active"
                            {...otherProps}
                          >
                            {!collapsed && subLabel}
      ...
      <div className="neeto-ui-sidebar__footer">
        ...
        <div className="neeto-ui-sidebar__links">
          {showChangelog && (
            <div className="neeto-ui-sidebar__link">
              <Rating />
