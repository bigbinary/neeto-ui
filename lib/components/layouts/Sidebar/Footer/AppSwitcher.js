  ...
  return (
    ...
    >
      <button
        ...
        className="flex items-center justify-start w-full shadow-none select-none neeto-ui-sidebar__link neeto-ui-sidebar__link--app-switcher neeto-ui-sidebar__link--button"
      >
