...
const ProfileSectionTooltip = ({ profileInfo }) => {
  ...
  return (
    <div className="neeto-ui-flex neeto-ui-flex-col neeto-ui-p-6">
      <div
        className={classnames("relative neeto-ui-flex neeto-ui-items-center", {
      ...
      >
        ...
        <div className="neeto-ui-flex neeto-ui-flex-col neeto-ui-flex-grow min-w-0 neeto-ui-pl-3">
          <Typography
            component="h2"
            style="h5"
            weight="semibold"
          ...
          {email && (
            <Typography
              style="body2"
              className="neeto-ui-w-full truncate neeto-ui-text-gray-600"
              lineHeight="tight"
            >
              {email}
            </Typography>
