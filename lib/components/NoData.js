    ...
    <div className={classnames("neeto-ui-no-data", [className])} data-cy="no-data-container" {...otherProps}>
      ...
      {description &&
        <Typography
          style="body2"
          lineHeight="normal"
          className="neeto-ui-text-gray-700 neeto-ui-text-center neeto-ui-mt-1"
      ...
      {helpText &&
        <Typography style="body2" lineHeight="normal" className="neeto-ui-text-gray-800 neeto-ui-mt-1 neeto-ui-text-center" data-cy="no-data-help-text">{helpText}</Typography>
      }
