...
const noop = () => {};
>>>>>>>> c6cd0daa (Added functionality to resie the columns):lib/components/Table/index.js
...
const Table = ({
  ...
  const { components, columns } = useResizableColumns({
    columnData,
    isEnabled: allowResize,
  });
