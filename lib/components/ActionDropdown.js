...
const ACTION_DROPDOWN_BTN_SIZES = {
  small: "small",
  medium: "medium",
  large: "large",
};
...
const ActionDropdown = ({
  label = "",
  style = ACTION_DROPDOWN_BTN_STYLES.primary,
  size = ACTION_DROPDOWN_BTN_SIZES.medium,
  disabled = false,
  onClick = noop,
...
ActionDropdown.propTypes = {
   ...
   */
  size: PropTypes.oneOf(Object.values(ACTION_DROPDOWN_BTN_SIZES)),
  /**
