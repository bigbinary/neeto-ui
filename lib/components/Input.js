  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <div className={classnames("relative w-full rounded-md", { "shadow-sm": !naked, "border-none": naked })}>
          {leadingIcon && (
          ...
          <div
            className={classnames(baseClasses, {
              "focus-within:shadow-focus-purple focus-within:border-purple-400": !inputError && !naked,
              [errorClasses]: !!inputError && !naked,
              "border-none": naked,
