...
import { useOverlayManager } from "../../managers/OverlayManager";
...
const Pane = ({
  ...
  const [hasTransitionCompleted, setHasTransitioinCompleted] = useState(false);
  ...
  return (
    <Portal rootId="neeto-ui-portal">
      <CSSTransition
        ...
        onEntered={() => setHasTransitioinCompleted(true)}
        onExited={() => setHasTransitioinCompleted(false)}
      >
        <Backdrop
          ref={backdropRef}
          key="pane-backdrop"
