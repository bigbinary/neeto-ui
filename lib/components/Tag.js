      ...
      {indicatorColor && (
        <span
          ...
          className={classnames("neeto-ui-tag__indicator", {
            "neeto-ui-bg-error-500": indicatorColor === COLORS.red,
            "neeto-ui-bg-info-500": indicatorColor === COLORS.blue,
            "neeto-ui-bg-warning-500": indicatorColor === COLORS.yellow,
            "neeto-ui-bg-success-500": indicatorColor === COLORS.green,
