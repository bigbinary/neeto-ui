...
const Table = ({
  ...
  const itemRender = (_, type, originalElement) => {
    if (type === "prev") {
      return <Button style="text" className="" icon={Left} size="large" />;
    }
  
    if (type === "next") {
      return <Button style="text" className="" icon={Right} size="large" />;
    }

    if (type === "jump-prev") {
      return <Button style="text" className="" icon={MenuHorizontal} size="large" />;
    }
