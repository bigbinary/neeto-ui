      ...
      return (
        <div className="neeto-ui-date-input-custom-panel">
          <div className="neeto-ui-date-input-custom-panel__header">
            <Button
              className="neeto-ui-date-input-custom-panel__header-now-btn"
              label="Now 09:43 PM"
              style="secondary"
            />
            <ul className="neeto-ui-date-input-custom-panel__header-cols">
              <li className="neeto-ui-date-input-custom-panel__header-col">Hour</li>
              <li className="neeto-ui-date-input-custom-panel__header-col">Minutes</li>
              <li className="neeto-ui-date-input-custom-panel__header-col">Seconds</li>
            </ul>
          </div>
