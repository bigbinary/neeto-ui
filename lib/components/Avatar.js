...
const Avatar = ({ contact, className, size, isOnline, activity }) => {
  ...
  const renderDefaultAvatar = () => 
    <div className={className} style={style}>
      <svg className="object-cover w-full h-full p-2 overflow-hidden text-white bg-purple-400 rounded-full" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0h24v24H0z"/><path fill="#ffffff" d="M4 22a8 8 0 1 1 16 0H4zm8-9c-3.315 0-6-2.685-6-6s2.685-6 6-6 6 2.685 6 6-2.685 6-6 6z"/></svg>
      {isOnline && <Indicator />}
    </div>
