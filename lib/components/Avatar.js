...
const Avatar = ({
  ...
  const Activity = () => {
    ...
    return (
      <div className="absolute bottom-0 right-0 flex items-center justify-center w-5 h-5 text-sm text-gray-700 transform translate-x-1 translate-y-2 rounded-full shadow-md bsolute bg-gray-100">
