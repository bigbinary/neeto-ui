...
const ColorPicker = ({
  ...
  const Target = ({ size }) => (
    ...
    >
      <div className="neeto-ui-colorpicker-target__code">{colorValue}</div>
    ...
    >
      <div className="neeto-ui-colorpicker__popover">
        <div className="neeto-ui-colorpicker__pointer">
          <HexColorPicker color={colorValue} onChange={onChangeColor} />
        </div>

        <div className="neeto-ui-flex neeto-ui-items-center neeto-ui-justify-center neeto-ui-mt-2">
          ...
          >
            <HexColorInput color={colorValue} onChange={onChangeColor} />
          </div>
        </div>
