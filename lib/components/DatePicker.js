...
const INPUT_SIZES = ["small", "medium", "large"];
    ...
    return (
      <div className="neeto-ui-input__wrapper">
        ...
        <Component
          ...
          {...otherProps}
          prevIcon={<Button style="text" icon={Left} size="large" />}
          nextIcon={<Button style="text" icon={Right} size="large" />}
          superPrevIcon={<Button style="text" icon={Left} size="large" />}
          superNextIcon={<Button style="text" icon={Right} size="large" />}
