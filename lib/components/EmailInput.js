...
const CustomControl = ({ children, ...props }) => {
  ...
  return (
    <components.Control {...props}>
      {prefix && <div className="neeto-ui-overflow-hidden">{prefix}</div>}
      {children}
    </components.Control>
  );
};
...
EmailInput.propTypes = {
  ...
  /**
   * To specify the content to be added at the end of the EmailInput field.
   */
  suffix: PropTypes.node,
  /**
   * To specify the content to be added at the beginning of the EmailInput field.
   */
