...
const CustomControl = ({ children, label, ...props }) => (
  <components.Control {...props} data-cy={`${hyphenize(label)}-input`}>
    <div
      className="neeto-ui-overflow-hidden"
...
const getCustomComponents = (label) => {
  return {
    DropdownIndicator: null,
    ClearIndicator: null,
    Control: (props) => CustomControl({ ...props, label }),
  };
};
  ...
  return (
    <div className="neeto-ui-flex neeto-ui-flex-col neeto-ui-email-input">
      ...
      <CreatableSelect
        ...
        components={getCustomComponents(label)}
