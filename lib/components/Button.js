...
const BUTTON_SIZES = { large: "large", xlarge: "xlarge", default: "default" };
    ...
    <Tooltip disabled={!tooltipProps} {...tooltipProps}>
      <Parent
        ...
        className={classnames("neeto-ui-btn", [className], {
          ...
          "neeto-ui-btn--style-danger-secondary": style === BUTTON_STYLES.danger_secondary,
          ...
          "neeto-ui-btn--size-xlarge": size === BUTTON_SIZES.xlarge,
        ...
        <AnimatePresence exitBeforeEnter>
          {icon ? (
            ...
            loading && (
              ...
              >
                <Spinner aria-hidden="true" key="3" className="neeto-ui-btn__spinner" />
              </motion.div>
            )
          )}
        </AnimatePresence>
