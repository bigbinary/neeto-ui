...
const Tags = ({
  ...
  return (
    <div className="neeto-ui-tags-wrapper">
      {label && <Typography style="h6" weight="bold" className="neeto-ui-text-gray-500 neeto-ui-mb-4">{label}</Typography>}
...
Tags.propTypes = {
  ...
  /**
   * To specify the text to be displayed above the Tags.
   */
