...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: '`import { Tags } from "@bigbinary/neetoui/molecules";`',
      },
    },
  },
};
...
const Template = (args) => {
  ...
  const onTagSelect = (tag) => setSelectedTags([...selectedTags, tag]);

  const onTagDelete = (tag) =>
    setSelectedTags(selectedTags.filter((ele) => ele.value !== tag.value));
