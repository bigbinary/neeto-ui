...
[neetoUI provides three predefined solid button variants](/docs/components-button--styles).
...
<Story name="Global Customization">
  <div className="h-screen">
    <iframe
      src="https://codesandbox.io/embed/mlxvmt?view=preview&module=%2Fsrc%2Fstyles.scss&hidenavigation=1"
      style={{
        width: "100%",
        height: "100vh",
        border: "0",
...
<Story name="Button Customization">
  <div className="h-screen">
    <iframe
      src="https://codesandbox.io/embed/n53f9m?view=preview&module=%2Fsrc%2Fstyles.scss&hidenavigation=1"
      style={{
        width: "100%",
        height: "100vh",
        border: "0",
