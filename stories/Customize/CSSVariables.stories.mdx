...
:root {
  ...
  --neeto-ui-primary-700: 54, 66, 223;
  --neeto-ui-primary-600: 64, 78, 236;
  --neeto-ui-primary-500: 69, 87, 248;
  --neeto-ui-primary-400: 99, 115, 252;
  --neeto-ui-primary-300: 130, 143, 253;
  --neeto-ui-primary-200: 168, 175, 254;
  --neeto-ui-primary-100: 204, 206, 254;
  --neeto-ui-primary-50: 235, 236, 255;
  --neeto-ui-error-800: 201, 37, 45;
  --neeto-ui-error-500: 215, 55, 63;
  --neeto-ui-error-100: 254, 236, 240;
  --neeto-ui-success-800: 18, 128, 92;
  --neeto-ui-success-500: 38, 142, 108;
  --neeto-ui-success-100: 225, 243, 238;
  --neeto-ui-warning-800: 203, 111, 16;
  --neeto-ui-warning-500: 218, 123, 17;
  --neeto-ui-warning-100: 251, 242, 225;
  --neeto-ui-info-800: 13, 102, 208;
  ...
  --neeto-ui-primary-focus-ring-color: rgba(var(--neeto-ui-primary-500), 15%);
  ...
  --neeto-ui-danger-focus-ring-color: rgba(var(--neeto-ui-error-500), 15%);
  --neeto-ui-danger-text-focus-ring-color: rgba(var(--neeto-ui-error-500), 15%);
