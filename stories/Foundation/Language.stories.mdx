...
<div className="demo-do-dont-wrap flex gap-4">
  <div className="demo-do-dont__box demo-do-dont__box--do rounded border-t-4 neeto-ui-border-success-500 p-6 w-80 neeto-ui-shadow-md">
  ...
  <div className="demo-do-dont__box demo-do-dont__box--dont rounded border-t-4 neeto-ui-border-error-500 p-6 w-80 neeto-ui-shadow-md">
    <h4 className="flex items-center gap-3">
...
Use international date format YYYY-MM-DD where

- YYYY is the year
- MM is the month
- DD is the day

For example, "3rd of April 2024", in this international format is written as 2024-04-03.
...
- Use “Cancel” button for users to back out of any changes made on a page, modal, pane etc.
