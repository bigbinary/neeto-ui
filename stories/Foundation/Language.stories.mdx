...
export const data = [
  ...
  { id: "alert-vs-modal", title: 'Alert vs. Modal' },
...
<h2 id="alert-vs-modal">
  <a href="#alert-vs-modal">Alert vs. Modal</a>
</h2>
...
- The action being done is reversible.
...
- Use the same language throughout your product.
...
- Help the user get out of the situation. If possible, provide a way for the user to correct the error. For example, you could provide a link to a knowledge base article or a way to reset the form.
...
- Do not validate fields on blur. This can be annoying for the user. Instead, validate fields on submit. This will allow the user to play around with the form until they are ready to submit it.
