...
<div className="demo-do-dont-wrap flex gap-4">
  ...
  <div className="demo-do-dont__box demo-do-dont__box--dont rounded border-t-4 neeto-ui-border-error-500 p-6 w-80 neeto-ui-shadow-md">
    ...
    <ul>
      ...
      <li>
        Looks like you don't have any forms!
      </li>
      <li>
      ...
      <li>
        <p>No tasks found.</p>
        <p>No tasks for you right now. You can go to projects and assign tasks to yourself</p>
      </li>
      <li>
        <p>Start building user tests</p>
        <p>You haven't created any test yet. Create your first test here and share it with your testers.</p>
      </li>
      <li>
      ...
      <li>
        Looks like you don't have any deals.
      </li>
      <li>
