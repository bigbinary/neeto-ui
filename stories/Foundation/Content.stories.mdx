...
<div className="demo-do-dont-wrap flex gap-4">
  <div className="demo-do-dont__box demo-do-dont__box--do rounded border-t-4 neeto-ui-border-success p-6 w-80 neeto-ui-shadow-m">
  ...
  <div className="demo-do-dont__box demo-do-dont__box--dont rounded border-t-4 neeto-ui-border-error p-6 w-80 neeto-ui-shadow-m">
    <h4 className="flex items-center gap-3">
