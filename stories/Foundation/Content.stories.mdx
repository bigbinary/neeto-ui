...
<div className="demo-do-dont-wrap flex gap-4">
  <div className="demo-do-dont__box demo-do-dont__box--do rounded border-t-4 neeto-ui-border-success-500 p-6 w-80 neeto-ui-shadow-m">
    ...
    <ul>
      <li>
        See <a href="https://neetodeskhelp.neetokb.com/articles/understanding-ticket-statuses" rel="noopener">
  ...
  <div className="demo-do-dont__box demo-do-dont__box--dont rounded border-t-4 neeto-ui-border-error-500 p-6 w-80 neeto-ui-shadow-m">
    ...
    <ul>
      <li>
        <a href="https://neetodeskhelp.neetokb.com/articles/understanding-ticket-statuses" rel="noopener">
        Click here</a> to see neetoDesk's ticket status documentation for more information.</li>
    </ul>
  </div>
</div>
<br/>
...
<div className="demo-do-dont-wrap flex gap-4">
  ...
  <div className="demo-do-dont__box demo-do-dont__box--dont rounded border-t-4 neeto-ui-border-error-500 p-6 w-80 neeto-ui-shadow-m">
    ...
    <ul>
      ...
      <li>If you leave this page, all unsaved changes will be lost. Are you sure you want to leave this page?</li>
    </ul>
  </div>
</div>
<br/>
