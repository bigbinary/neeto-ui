  ...
  return (
    <div className="w-full">
      ...
      <div className="flex flex-col items-start justify-start p-6">
        <div className="mb-12">
          <h4 className="mb-3 text-sm font-medium text-gray-800">Icon Picker</h4>
        ...
        <div className="mb-12">
          <h4 className="mb-3 text-sm font-medium text-gray-800">Color Picker</h4>
          <ColorPicker
            onChange={(value) => {}}
            color="#fefefe"
            colorPaletteProps={{
